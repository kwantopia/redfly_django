# Django settings for redfly project.
import os
...
SECRET_KEY = 'knh7gcd4c@vudcid^5u+!l6xs=+dm%525fg$zt2=ug#d=bl(lk'
...
ROOT_URLCONF = 'redfly.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'redfly.wsgi.application'
